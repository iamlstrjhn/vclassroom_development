          ...
          <div class="navbar">
            ...
            <nav class="navbar-for-chat">
              <div class="nav-wrapper">
                ...
                <a class="right" href="<?php echo base_url('Message') ?>"><i class="material-icons">close</i></a>
                            ...
                            <script type="text/javascript">
                              ...
                              $(document).ready(function(){  
                                setInterval(function(){
                                  $('#live-chat').load('<?php echo base_url('chat/get_messages/').$id ?>');
                                },2000);
                              }); 
                              ...
                              function send()
                              {
                                ...
                                $.ajax({
                                  type:'POST',
                                  url:'<?php echo base_url('chat/send_messages/').$id ?>',
                                  data:"message="+ chat,  
                                  dataType:"dataString", 
                                  cache:false,
                                })
